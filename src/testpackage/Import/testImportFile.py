...
ImportFileData = [   
    {'Date': datetime.datetime(2011, 8, 22, 0, 0), 'Hours': [datetime.datetime(2011, 8, 22, 8, 30),  datetime.datetime(2011, 8, 22, 9, 15)], 'Subject': 'Adv. networking', 'Location': 'b-1.44', 'Class': '11OIT3bH2'}, 
    {'Date': datetime.datetime(2011, 8, 22, 0, 0), 'Hours': [datetime.datetime(2011, 8, 22, 9, 15),  datetime.datetime(2011, 8, 22, 10, 0)], 'Subject': 'Adv. networking', 'Location': 'b-1.44', 'Class': '11OIT3bH2'}, 
    {'Date': datetime.datetime(2011, 8, 22, 0, 0), 'Hours': [datetime.datetime(2011, 8, 22, 10, 20), datetime.datetime(2011, 8, 22, 11, 5)], 'Subject': 'Adv. networking', 'Location': 'b-1.44', 'Class': '11OIT3bH2'}, 
    {'Date': datetime.datetime(2011, 8, 23, 0, 0), 'Hours': [datetime.datetime(2011, 8, 22, 11, 5),  datetime.datetime(2011, 8, 22, 11, 50)], 'Subject': 'Adv. networking', 'Location': 'b-1.44', 'Class': '11OIT3bH2'}, 
    {'Date': datetime.datetime(2011, 8, 23, 0, 0), 'Hours': [datetime.datetime(2011, 8, 23, 8, 30),  datetime.datetime(2011, 8, 23, 9, 15)], 'Subject': 'IT Security', 'Location': 'b-1.44', 'Class': '11OIT3bH2'}, 
    {'Date': datetime.datetime(2011, 8, 23, 0, 0), 'Hours': [datetime.datetime(2011, 8, 23, 9, 15),  datetime.datetime(2011, 8, 23, 10, 0)], 'Subject': 'IT Security', 'Location': 'b-1.44', 'Class': '11OIT3bH2'},
    {'Date': datetime.datetime(2011, 8, 26, 0, 0), 'Hours': [datetime.datetime(2011, 8, 23, 10, 20), datetime.datetime(2011, 8, 23, 11, 5)], 'Subject': 'IT Security', 'Location': 'b-1.44', 'Class': '11OIT3bH2'}, 
