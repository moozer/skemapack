...
AD_DataSet1 = [ActivityData(Teacher = Teacher1, Class = Class1, Course = Course1, LessonsList = LessonsByWeek1 )]
AD_DataSet2 = [ActivityData(Teacher = Teacher2, Class = Class1, Course = Course1, LessonsList = [] )]
